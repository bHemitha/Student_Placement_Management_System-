...
<?php require_once "../helpers/navbar.php" ?>
    <div style="padding:10%;">
        <h1 style="text-align:center;">Company Log In</h1>
        <div style="color:red;text-align:center;">
            <?php echo $_SESSION['login_message'] ?? '' ?>
        </div>


        <form action="login_company.php" method="post">
            <div style="color:red;text-align:center;">
            ...
            <div>
                <p style="color:black;text-align:center;">Don't have an account?<a href="register_company.php">Create a new account.</a></p>
            </div>
        </form>
    </div>
