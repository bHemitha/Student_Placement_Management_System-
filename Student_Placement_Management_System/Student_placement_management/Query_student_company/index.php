        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="logincompany.php"><span class="glyphicon glyphicon-log-in"></span> Login as company</a></li>
                    <li><a href="loginstudent.php"><span class="glyphicon glyphicon-log-in"></span> Login as student</a></li>
                </ul>
            </div>
        </div>
    </nav>
